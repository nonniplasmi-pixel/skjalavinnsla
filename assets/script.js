window.addEventListener('load', () => {
  ...
  document.getElementById('file').addEventListener('change', async (e) => {
    ...
    try {
      ...
      document.getElementById('summary').textContent = "Gat ekki lesið PDF: " + (err?.message || err);
    } finally {
      document.getElementById('ocrState').classList.add('hidden');
    }
  });

  document.getElementById('parseBtn').addEventListener('click', () => {
    const t = document.getElementById('raw').value || "";
  ...
  document.getElementById('clearBtn')?.addEventListener('click', () => {
    ...
    document.getElementById('summary').textContent = "Hladdu upp PDF eða límdu texta hér að neðan.";
    document.getElementById('checklist').innerHTML = ""; document.getElementById('jsonOut').value = "";
  });

  ['hasLoan','hasChain','hasLandLease'].forEach(id => {
    const el = document.getElementById(id);
    if (el) el.addEventListener('change', checklist);
  });
